...
class Model:
    ...
    # Train the model
    def train(
        self, X, y, *, epochs=1, print_every=1, validation_data=None, batch_size=None
    ):
...
model.set(
    ...
    optimizer=Optimizer_Adam(decay=1e-4, learning_rate=0.001),
...
model.train(
    X, y, validation_data=(X_test, y_test), epochs=10, batch_size=50, print_every=100
)
model.save("fashion_mnist5.model")
# parameters = model.get_parameters()
# model.load('fashion_mnist.model')
